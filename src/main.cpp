...
#define REWARD_CUT_BLOCK 30700010
...
unsigned int nStakeMinAge = 60 * 60 * 24; // 1 Day
...
const string strMessageMagic = "Chécoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Chécoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Linux Foundation Wants Open-Source Tech to Address Future Pandemics";
        CTransaction txNew;
        txNew.nTime = 1597290693;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1597290693;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 420295;
        if(fTestNet)
        {
            block.nTime = 1597290711;
            block.nNonce = 28833;         
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe61470c68ec2a49ffb3163f5b1e8f67234df527d20ed173cf0ee8d67c7a95d9c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x53, 0x47, 0x44, 0x43 };
